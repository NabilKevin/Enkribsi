...
const Edit = ({setShowPopup, children}) => {
  ...
  const {singleExecute} = useMultipleFetch({fetchs: [HrService.editOffice, HrService.getOffice], setLoading, 
    errorCallbackMap: {
      editOffice: handleError,
      getOffice: handleError
    },
    successCallbackMap: {
      editOffice: handleSuccess,
      getOffice: handleSuccessGet
    }
  })
  ...
  const handleSubmit = e => {
    e.preventDefault();
    singleExecute('editOffice', {data: formData, id})
  }

  useEffect(() => {
    singleExecute('getOffice', id)
  }, [])
