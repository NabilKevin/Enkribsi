...
const {data, singleExecute} = useMultipleFetch({fetchs: [HrService.getSchedules, HrService.deleteSchedule], setLoading,
    errorCallbackMap: {
      getSchedules: handleError,
      deleteSchedule: handleError,
    },
    successCallbackMap: {
      deleteSchedule: handleSuccess
    }
  })
  ...
  return (
    <Container>
      ...
      <div className="d-flex justify-content-between mb-3 align-items-center header-text-schedule">
        <h2>List Jadwal</h2>
        <a className='btn btn-dark' href="/hr/schedules/create">Buat Jadwal</a>
      </div>
      <hr />
      {
                ...
                data.getSchedules.map((d, i) => (
                  <tr key={i}>
                    ...
                    <td>
                      ...
                      <a className="btn btn-primary ms-1 btn-action-schedule mt-1" href={`/hr/schedules/${d.id}/edit`}>
                      ...
                      <ModalBoxButton className="btn btn-danger ms-1 mt-1 btn-action-schedule" callback={() => setModalContent({
                        ...
                        content: <span>Yakin ingin menghapus Jadwal ini? ({d.name})</span>,
                        callback: () =>  singleExecute('deleteSchedule', d.id)
                      })}>
