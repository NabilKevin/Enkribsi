...
const Create = ({setShowPopup, children}) => {
  ...
  const {execute} = useMultipleFetch({fetchs: [HrService.createWfhSchedule], setLoading, 
    errorCallbackMap: {
      createWfhSchedule: handleError
    },
    successCallbackMap: {
      createWfhSchedule: handleSuccess
    }
  })
  ...
  return (
    <Container>
      {children}
      <h1 className='mb-4'>Buat jadwal WFH</h1>
      <hr />
