...
const {data, singleExecute} = useMultipleFetch({fetchs: [HrService.getWfhSchedules, HrService.deleteWfhSchedule], setLoading,
    errorCallbackMap: {
      getWfhSchedules: handleError,
      deleteWfhSchedule: handleError,
    },
    successCallbackMap: {
      deleteWfhSchedule: handleSuccess
    }
  })
  ...
  return (
    <Container>
      {children}
      <h1 className='mb-5'>Jadwal WFH</h1>
      <div className="d-flex justify-content-between mb-3 align-items-center header-text-wfhschedule">
        <h2>List Jadwal WFH</h2>
        <a className='btn btn-dark' href="/hr/wfh/schedules/create">Buat Jadwal WFH</a>
      </div>
      <hr />
      {
                ...
                data.getWfhSchedules.data.map((d, i) => (
                  <tr key={i}>
                    ...
                    <td>
                      ...
                      <a className="btn btn-primary ms-1 btn-action-Wfhschedule mt-1" href={`/hr/wfh/schedules/${d.id}/edit`}>
                      ...
                      <ModalBoxButton className="btn btn-danger ms-1 mt-1 btn-action-Wfhschedule" callback={() => setModalContent({
                        ...
                        callback: () =>  singleExecute('deleteWfhSchedule', d.id)
                      })}>
