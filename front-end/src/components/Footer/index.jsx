...
const Header = () => {
  return (
    <div className="footer">
        <a href="/"  className="d-flex align-items-center flex-column text-decoration-none">
        ...
        <a href="#"  className="d-flex align-items-center flex-column text-decoration-none">
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-file-earmark-bar-graph" viewBox="0 0 16 16">
