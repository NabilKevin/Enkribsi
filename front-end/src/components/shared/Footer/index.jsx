...
import { FooterButton } from './components.jsx'

const Footer = () => {
  return (
    <div className="footer shadow">
        <FooterButton active={''} link={'/'} name={'Beranda'}>
        ...
        <FooterButton active={'statistics'} link={'/statistics'} name={'Statistik'}>
        ...
        <FooterButton active={'permits'} link={'/permits'} name={'Perizinan'}>
        ...
        <FooterButton active={'profile'} link={'/profile'} name={'Profil'}>
