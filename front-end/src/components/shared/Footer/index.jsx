...
const Footer = () => {
  return (
    <div className="footer shadow">
        <FooterButton link={'/'} name={'Beranda'}>
        ...
        <FooterButton link={'/statistik'} name={'Statistik'}>
        ...
        <FooterButton link={'/perizinan'} name={'Perizinan'}>
        ...
        <FooterButton link={'/profil'} name={'Profil'}>
